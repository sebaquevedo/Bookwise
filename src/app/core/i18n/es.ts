export const ES: Record<string, string> = {
  ...
  'toast.patient_required.detail': 'Selecciona o agrega un paciente antes de guardar.',
  ...
  'toast.reconnected.detail': 'Puedes volver a trabajar con normalidad.',
  ...
  'error.401.detail': 'Tu sesión expiró. Inicia sesión de nuevo.',
  'error.402.detail': 'Se requiere pago para continuar.',
  'error.403.detail': 'No tienes permisos para realizar esta acción.',
  'error.404.detail': 'El recurso ya no existe. Recarga la página.',
  'error.409.detail': 'Ese horario ya está ocupado. Revisa el calendario antes de confirmar.',
  'error.422.detail': 'Hay campos con errores. Revisa el formulario.',
  'error.429.detail': 'Demasiadas solicitudes. Espera un momento e intenta de nuevo.',
  'error.500.detail': 'Error interno del servidor. Si persiste, contacta soporte.',
  'error.502.detail': 'El servidor no responde. Intenta en unos minutos.',
  'error.503.detail': 'El servicio está temporalmente no disponible.',
  'error.504.detail': 'El servidor tardó demasiado en responder. Intenta de nuevo.',
  'error.default.detail': 'Ocurrió un error inesperado. Intenta de nuevo.',
  ...
  'biz.invalid_input.detail':              'Verifica los campos e intenta de nuevo.',
  'biz.forbidden.detail':                  'No tienes permisos para realizar esta acción.',
  ...
  // Auth
  'auth.login_error': 'Credenciales incorrectas. Intenta de nuevo.',
  'auth.register_error': 'Error al crear la cuenta. Intenta de nuevo.',
  'auth.register_check_email': 'Cuenta creada. Revisa tu correo para verificar tu email.',
  ...
  'ui.close_menu': 'Cerrar menú',
  'ui.toggle_menu': 'Abrir menú',
  ...
  'billing.subtitle': 'Gestión de suscripción y consumo',
  'billing.invoices_button': 'Facturas',
  'billing.current_plan': 'Plan actual',
  'billing.active': 'Activo',
  'billing.account_number': 'Cuenta #{{id}}',
  'billing.autorenew': 'Renovación automática el {{date}}',
  'billing.payment_method': 'Método de pago',
  'billing.monthly_billing': 'Facturación mensual',
  'billing.change_plan': 'Cambiar plan',
  'billing.manage_subscription': 'Gestionar suscripción',
  'billing.current_period': 'Período actual: {{start}} – {{end}}',
  'billing.days_left': '{{n}} días restantes',
  'billing.usage_title': 'Uso del plan',
  'billing.updated_recent': 'Actualizado hace 12 min',
  'billing.usage.locations': 'Sucursales',
  'billing.usage.providers': 'Profesionales',
  'billing.usage.clients': 'Clientes',
  'billing.usage.allowed': '{{used}} / {{limit}} permitidos',
  'billing.usage.locations_hint': '{{n}} sucursales disponibles antes de requerir upgrade',
  'billing.usage.providers_warning': 'Cerca del límite — considera un upgrade',
  'billing.usage.clients_hint': '{{n}} clientes disponibles este mes',
  'billing.consumption_title': 'Consumo mensual',
  'billing.details_title': 'Detalles del plan',
  'billing.feature.locations': 'Hasta 5 sucursales',
  'billing.feature.providers': 'Hasta 8 profesionales',
  'billing.feature.clients': '100.000 clientes activos',
  'billing.feature.support': 'Soporte prioritario 24/7',
  'billing.feature.messages': 'Hasta 50.000 mensajes/mes',
  'billing.see_all_plans': 'Ver todos los planes',
  'billing.history_title': 'Historial de facturación',
  'billing.history.subtitle': 'Últimas facturas emitidas en esta cuenta',
  'billing.invoice': 'Factura',
  'billing.date': 'Fecha',
  'billing.plan_col': 'Plan',
  ...
  'settings.subtitle': 'Ajusta tu cuenta, la apariencia y tu negocio',
  ...
  'landing.pricing.subtitle': 'Elige el plan que crece con tu centro. Precios mensuales en CLP.',
  ...
  'avail.subtitle': 'Configura tu semana estándar y mira cómo se ve en el mes o en un rango de fechas',
  'avail.week_standard': 'Semana estándar',
  'avail.week_standard.hint': 'Configura un día y cópialo al resto, o agrega rápido por día.',
  'avail.week_standard.info': 'Los horarios que se repiten cada semana. Usa + para agregar y "Copiar al resto" para replicar un día.',
  'avail.add': 'Agregar horario',
  'avail.no_schedule': 'Sin horario',
  'avail.copy_to_week': 'Copiar al resto',
  'avail.preview': 'Vista previa',
  'avail.preview.info': 'Semanas: navega por semanas del mes. Meses: el calendario. Rango: un periodo puntual. Las reservas (azul) y los bloqueos (rayado) se descuentan de lo disponible.',
  'avail.weeks': 'Semanas',
  'avail.months': 'Meses',
  ...
  'avail.clear': 'Limpiar',
  'avail.range_empty': 'Elige un rango de fechas para ver la proyección.',
  ...
  'similar_patients.subtitle': 'Selecciona un paciente existente o asigna a un nuevo perfil.',
  ...
  'verify_email.subtitle': 'Confirma tu dirección de correo para continuar',
  ...
  'auth.verify_email_error': 'No se pudo verificar tu email. Intenta de nuevo.',

  // Onboarding (negocio)
  'onboard.title': 'Configura tu negocio',
  'onboard.subtitle': 'Completa los datos para activar tu cuenta',
  ...
  'onboard.business_type': '¿Qué tipo de negocio tienes?',
  'onboard.business_type.placeholder': 'Selecciona una opción',
  'onboard.business_type.other_placeholder': 'Escribe tu tipo de negocio',
  'onboard.business_type.yoga_studio': 'Yoga studio',
  'onboard.business_type.other': 'Otro',
  'onboard.professionals_short': 'Cantidad de profesionales',
  'onboard.terms.prefix': 'Al crear tu negocio, aceptas nuestros',
  'onboard.terms.link': 'términos y condiciones',
  ...
  'onboard.error.professionals_required': 'La cantidad de profesionales es obligatoria',
  'onboard.error.professionals_min': 'Debe ser al menos 1',
  'onboard.error.business_type_required': 'El tipo de negocio es obligatorio',
  'onboard.error.business_type_other_required': 'Describe tu tipo de negocio',
  ...
  'profile.change_password.meter_prompt': 'Ingresa una contraseña',
  ...
  'profile.business.cta_hint': 'Completa el onboarding para registrar tu negocio.',

  // Roles de negocio
  'roles.title': 'Roles de negocio',
  'roles.subtitle': 'Asigna roles a los profesionales de tu negocio',
  'roles.provider': 'Profesional',
  'roles.provider_placeholder': 'Seleccionar profesional',
  'roles.provider_required': 'Selecciona un profesional.',
  'roles.save': 'Guardar roles',
  'roles.empty_error': 'Selecciona al menos un rol.',
  ...
  'roles.cards_subtitle': 'Conoce qué puede hacer cada rol en tu negocio.',
