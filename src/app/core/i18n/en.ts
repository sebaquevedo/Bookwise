export const EN: Record<string, string> = {
  ...
  'billing.subtitle': 'Subscription and usage management',
  'billing.invoices_button': 'Invoices',
  'billing.current_plan': 'Current plan',
  'billing.active': 'Active',
  'billing.account_number': 'Account #{{id}}',
  'billing.autorenew': 'Auto-renewal on {{date}}',
  'billing.payment_method': 'Payment method',
  'billing.monthly_billing': 'Monthly billing',
  'billing.change_plan': 'Change plan',
  'billing.manage_subscription': 'Manage subscription',
  'billing.current_period': 'Current period: {{start}} – {{end}}',
  'billing.days_left': '{{n}} days left',
  'billing.usage_title': 'Plan usage',
  'billing.updated_recent': 'Updated 12 min ago',
  'billing.usage.locations': 'Locations',
  'billing.usage.providers': 'Providers',
  'billing.usage.clients': 'Clients',
  'billing.usage.allowed': '{{used}} / {{limit}} allowed',
  'billing.usage.locations_hint': '{{n}} locations available before an upgrade is required',
  'billing.usage.providers_warning': 'Close to the limit — consider an upgrade',
  'billing.usage.clients_hint': '{{n}} clients available this month',
  'billing.consumption_title': 'Monthly usage',
  'billing.details_title': 'Plan details',
  'billing.feature.locations': 'Up to 5 locations',
  'billing.feature.providers': 'Up to 8 professionals',
  'billing.feature.clients': '100,000 active clients',
  'billing.feature.support': 'Priority support 24/7',
  'billing.feature.messages': 'Up to 50,000 messages/month',
  'billing.see_all_plans': 'See all plans',
  'billing.history_title': 'Billing history',
  'billing.history.subtitle': 'Latest invoices issued on this account',
  ...
  'onboard.business_type': 'What type of business do you have?',
  'onboard.business_type.placeholder': 'Select an option',
  'onboard.business_type.other_placeholder': 'Type your business type',
  'onboard.business_type.yoga_studio': 'Yoga studio',
  'onboard.business_type.other': 'Other',
  'onboard.professionals_short': 'Number of professionals',
  'onboard.terms.prefix': 'By creating your business, you accept our',
  'onboard.terms.link': 'terms and conditions',
  ...
  'onboard.error.professionals_required': 'Number of professionals is required',
  'onboard.error.professionals_min': 'Must be at least 1',
  'onboard.error.business_type_required': 'Business type is required',
  'onboard.error.business_type_other_required': 'Describe your business type',
